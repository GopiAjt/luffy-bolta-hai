...
def build_slides_response(
    ...
    for index, slide in enumerate(slides):
        ...
        items.append({
            ...
            "visual_purpose": slide.get("visual_purpose") or "",
            ...
            "viewer_focus": slide.get("viewer_focus") or "",
            "manual_upload_brief": slide.get("manual_upload_brief") or "",
            "avoid_visual_reuse": slide.get("avoid_visual_reuse") or "",
            "asset_metadata": slide.get("asset_metadata") or {},
            "visual_intent": slide.get("visual_intent") or {},
            "emotion_state": slide.get("emotion_state") or {},
            "visual_diversity_score": slide.get("visual_diversity_score"),
            "diversity_notes": slide.get("diversity_notes") or "",
            "character_relationships": slide.get("character_relationships") or [],
            "retention_score": slide.get("retention_score"),
            "retention_actions": slide.get("retention_actions") or [],
            "composition_layers": slide.get("composition_layers") or [],
            "motion_plan": slide.get("motion_plan") or {},
            "architecture_stage": slide.get("architecture_stage"),
            "architecture_path": slide.get("architecture_path") or [],
            "has_image": has_image,
