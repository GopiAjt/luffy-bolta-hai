...
PROSODY_MARKUP_RULES = (
    ...
    "- Treat punctuation as prosody shaping: decide where the narrator breathes, pivots, suspends, lands, and punches.\n"
    "- Do a punctuation shaping pass after drafting: every sentence should have an intentional spoken rhythm, not default grammar-only punctuation.\n"
    "- Write for voiceover breath groups, not essay prose: most spoken beats should land in 6-14 word chunks before a comma, dash, ellipsis, or period.\n"
    ...
    "- Avoid long comma-free sentences. If a line would make the narrator run out of breath, reshape it with commas, a dash, or a split sentence.\n"
    "- Put the strongest pause immediately before the reveal word or canon anchor that should land hardest.\n"
    "- Avoid polished explanatory sentences like 'He prioritizes his captain's life, knowing...' when a spoken version can hit harder: 'He saves his captain first — even if his own dream dies there.'\n"
...
def _build_prompt(
    ...
    return (
        ...
        "- Did you perform a punctuation shaping pass so every sentence has a deliberate spoken rhythm? If no, rewrite.\n"
        "- Does any sentence sound like essay prose instead of spoken voiceover? If yes, break it into shorter breath groups with commas, dashes, ellipses, or periods.\n"
